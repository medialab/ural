...
# =============================================================================
from ural.twitter import TwitterUser, is_twitter_url, extract_screen_name_from_twitter_url, parse_twitter_url, TwitterUser
...
PARSE_TWEET_URL_TESTS = [
    ...
    ('https://twitter.com', None),
    ('https://twitter.com/Yomguithereal?s=19', TwitterUser(user_screen_name='yomguithereal'))
]
